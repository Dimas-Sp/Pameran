    ...
    <div id="page">
        ...
        <div class="page-content">
            ...
            <div class="row text-center mb-3">
                <a href="{{ url('/menurpl') }}" class="col-6 pr-2">
                    <div class="card card-style mr-0  pt-4 mb-3">
                        <h1 class="center-text pt-4">
                            <i data-feather="file" data-feather-line="1" data-feather-size="50"
                                data-feather-color="blue2-dark" data-feather-bg="blue2-fade-light">
                            </i>
                        </h1>
                ...
                <a href="{{ url('/menutkj') }}" class="col-6 pl-2">
                    <div class="card card-style ml-0 mb-3 pt-4">
                        <h1 class="center-text pt-4">
                            <i data-feather="settings" data-feather-line="1" data-feather-size="50"
                ...
                <a href="{{ url('/menutkr') }}" class="col-6 pr-2">
                ...
                <a href="{{ url('/menutfl') }}" class="col-6 pl-2">
                    <div class="card card-style ml-0 mb-3 pt-4">
                        <h1 class="center-text pt-4">
                            <i data-feather="image" data-feather-line="1" data-feather-size="50"
                                data-feather-color="orange-dark" data-feather-bg="orange-fade-light">
                            </i>
                        </h1>
                        <h4 class="color-theme font-600">TFL</h4>
                        <p class="mt-n2 font-11 color-highlight">
                            Modal Menus & Actions
                        </p>
                        <p class="font-10 opacity-30 mb-1">Tap to View</p>
                ...
                <!-- <a href="page-contact.html" class="col-6 pr-2">
                    <div class="card card-style mr-0 mb-3  pt-4">
                        <h1 class="center-text pt-4">
                            <i data-feather="mail" data-feather-line="1" data-feather-size="50"
                                data-feather-color="blue2-dark" data-feather-bg="blue2-fade-light">
                            </i>
                        </h1>
                ...
                <a href="tel:+1 234 567 8991" class="col-6 pl-2">
                    <div class="card card-style ml-0 mb-3  pt-4">
                        <h1 class="center-text pt-4">
                            <i data-feather="phone" data-feather-line="1" data-feather-size="50"
            ...
            <div id="menu-highlights" class="menu menu-box-bottom menu-box-detached rounded-m"
                data-menu-load="{{ url('azure') }}/menu-colors.html" data-menu-height="510"
